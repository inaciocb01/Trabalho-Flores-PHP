...
/* Descritivo:O programa solicita ao usuário um valor em reais e a taxa de cotação do dólar. Em seguida, divide o valor em reais pela cotação para calcular o valor equivalente em dólares e exibe os resultados formatados na tela. */
?>